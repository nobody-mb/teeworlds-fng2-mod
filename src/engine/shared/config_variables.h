...
MACRO_CONFIG_INT(SvAnnouncementInterval, sv_announcement_interval, 7200, 1, 100000, CFGFLAG_SERVER, "time(Seconds) in which the announcement will be displayed from the announcement file")
